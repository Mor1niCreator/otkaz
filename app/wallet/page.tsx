  ...
  return (
    <div className="pb-24 px-4 py-6 max-w-screen-lg mx-auto">
      <div className="enough-panel mb-6">
        ...
        <div className="bg-gradient-to-r from-black to-comic-pink rounded-2xl border-4 border-black p-6 mb-6 enough-shadow-lg">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-enough-yellow rounded-xl border-4 border-black p-4 text-center">
      ...
      {topTags.length > 0 && (
        <div className="enough-panel mb-6 bg-gradient-to-r from-purple-100 to-pink-100">
